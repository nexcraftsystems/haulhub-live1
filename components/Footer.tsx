        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="space-y-8">
            ...
            <div className="flex space-x-5">
              {[Twitter, Facebook, Instagram, Linkedin].map((Icon, i) => (
                <span key={i} className="w-12 h-12 flex items-center justify-center bg-slate-900 border border-slate-800 rounded-2xl text-slate-500">
                  <Icon size={22} />
                </span>
              ))}
            </div>
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-4 text-slate-400">
              ...
              <li><Link to="/contact" className="hover:text-blue-400">Invest with us</Link></li>
              <li><Link to="/services" className="hover:text-blue-400">Our Services</Link></li>
              <li><Link to="/industries" className="hover:text-blue-400">Industries</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-slate-400">
              ...
              <div className="flex items-center gap-4">
                ...
                <p>Office Tel: 603 8685 9434</p>
              </div>
              <div className="flex items-center gap-4">
                <Mail size={24} className="text-blue-500 shrink-0" />
                <p>Email: sales@haulhub.my</p>
              </div>
            </div>
          </div>
        </div>
